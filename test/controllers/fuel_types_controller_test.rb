...
class FuelTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fuel_type" do
    assert_difference('FuelType.count') do
      post fuel_types_url, params: { fuel_type: { fuelname: @fuel_type.fuelname, price: @fuel_type.price, user_id: @fuel_type.user_id } }
    end
  ...
  test "should update fuel_type" do
    patch fuel_type_url(@fuel_type), params: { fuel_type: { fuelname: @fuel_type.fuelname, price: @fuel_type.price, user_id: @fuel_type.user_id } }
